                ...
                <ul>
                    {this
                        ...
                        .map(strResult => (
                            <li
                                key={strResult.id}
                                onClick={(id) => this.props.onDeleteResult(strResult.id)}>{strResult.value}</li>
                        ))}
                </ul>
            </div>
        );
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onAdd5: () => dispatch({type: actionTypes.ADD_5, value: 5}),
        onSubtract5: () => dispatch({type: actionTypes.SUBTRACT_5, value: 5}),
